...
public class FavoritosService {
    ...
    public Favoritos buscarPorId(Long id) {
        return favoritosRepository.findById(id)
                .orElseThrow(() -> new EntidadeNaoEncontradaException("Filme Favorito não encontrado com o ID: " + id));
    }
    ...
    public Favoritos atualizar(Long id, Favoritos favoritos) {
        ...
        if (!favoritosRepository.existsById(id)) {
            throw new EntidadeNaoEncontradaException("Filme Favorito não encontrado com o ID: " + id);
        }
